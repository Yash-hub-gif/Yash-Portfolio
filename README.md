# UI/UX Designer & Lead Generation Portfolio
...
- `Aarav Shah`
- `AS`
- `UI/UX Designer & Lead Generation Executive`
- `hello@example.com`
- `+91 98765 43210`
...
- Contact form destination email in the `mailto:hello@example.com` line
